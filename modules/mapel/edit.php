            ...
            <div class="card-body p-4">
                ...
                <form method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_mapel" value="<?php echo htmlspecialchars($mapel['nama_mapel']); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Kode Mapel</label>
                        <input type="text" class="form-control" name="kode_mapel" value="<?php echo htmlspecialchars($mapel['kode_mapel'] ?? ''); ?>">
                    </div>
