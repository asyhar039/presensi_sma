    ...
    if (!verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($nama_kelas) || empty($tingkat)) {
            ...
            try {
                ...
                $stmt->bind_param("sssii", $nama_kelas, $tingkat, $jurusan, $guru_id, $kelas_id);
...
<head>
    ...
    <title>Edit Kelas - Sistem Absensi SMA</title>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="tingkat" id="tingkat" required>
                                <option value="10" <?php echo $kelas['tingkat'] == 10 ? 'selected' : ''; ?>>X (10)</option>
                                <option value="11" <?php echo $kelas['tingkat'] == 11 ? 'selected' : ''; ?>>XI (11)</option>
                                <option value="12" <?php echo $kelas['tingkat'] == 12 ? 'selected' : ''; ?>>XII (12)</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3" id="jurusan-container">
                            <label class="form-label">Jurusan</label>
                            <input type="text" class="form-control" name="jurusan" id="jurusan" value="<?php echo htmlspecialchars($kelas['jurusan'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="guru_id">
                            ...
                            <?php foreach ($guru_list as $guru): ?>
                                <option value="<?php echo $guru['id']; ?>" <?php echo $kelas['guru_id'] === $guru['id'] ? 'selected' : ''; ?>><?php echo htmlspecialchars($guru['nama_lengkap']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
