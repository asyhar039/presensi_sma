...
try {
    $result = query("SELECT * FROM siswa WHERE id = $siswa_id AND is_active = 1", $conn);
    ...
    if (!verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($nisn) || empty($nama) || empty($jenis_kelamin) || $kelas_id <= 0) {
            ...
            try {
                ...
                $stmt->bind_param("ssssssi", $nisn, $nama, $jenis_kelamin, $tanggal_lahir, $no_telp, $alamat, $kelas_id, $siswa_id);
...
<head>
    ...
    <title>Edit Siswa - Sistem Absensi SMA</title>
            ...
            <div class="card-body p-4">
                ...
                <form method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nisn" value="<?php echo htmlspecialchars($siswa['nisn']); ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="kelas_id" required>
                            <?php foreach ($kelas_list as $kelas): ?>
                                <option value="<?php echo $kelas['id']; ?>" <?php echo $siswa['kelas_id'] === $kelas['id'] ? 'selected' : ''; ?>><?php echo htmlspecialchars($kelas['nama_kelas']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" name="no_telp" value="<?php echo htmlspecialchars($siswa['no_telp'] ?? ''); ?>">
                    </div>
